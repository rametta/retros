...
renderForm column = formFor column [hsx|
    ...
    <div class="flex justify-between">
        ...
        <a href={DeleteColumnAction $ get #id column} class="js-delete block bg-red-500 hover:bg-red-400 text-white font-bold py-1 px-2 rounded transition duration-300">Delete Item</a>
     </div>
|]